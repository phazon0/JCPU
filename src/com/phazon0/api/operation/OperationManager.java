package com.phazon0.api.operation;

import com.phazon0.api.CPU;
import com.phazon0.api.operation.instruction.Instruction;
import com.phazon0.api.operation.instruction.impl.ADD;
import com.phazon0.api.operation.instruction.impl.CLEAR;
import com.phazon0.api.operation.instruction.impl.CMP;
import com.phazon0.api.operation.instruction.impl.JUMP;
import com.phazon0.api.operation.instruction.impl.LOAD;
import com.phazon0.api.operation.instruction.impl.SET;
import com.phazon0.api.operation.instruction.impl.STORE;
import com.phazon0.api.operation.instruction.impl.SUB;
import com.phazon0.api.operation.instruction.impl.branch.BRANCH;
import com.phazon0.api.operation.instruction.impl.branch.BranchMode;
import com.phazon0.api.operation.instruction.impl.logical.AND;
import com.phazon0.api.operation.instruction.impl.logical.BIT;
import com.phazon0.api.operation.instruction.impl.logical.EOR;
import com.phazon0.api.operation.instruction.impl.logical.ORA;
import com.phazon0.api.operation.instruction.impl.stack.STACK;
import com.phazon0.api.operation.instruction.impl.stack.StackMode;
import com.phazon0.api.operation.instruction.impl.system.BREAK;
import com.phazon0.api.operation.instruction.impl.system.NOP;
import com.phazon0.api.operation.instruction.impl.transfer.TRANSFER;
import com.phazon0.api.operation.instruction.impl.transfer.TransferMode;
import com.phazon0.api.register.IndexRegisterType;
